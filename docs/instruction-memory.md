...
| supersedes | Optional explicit predecessor rule IDs; an applicable successor excludes its predecessor, while competing successors remain an explicit conflict |
